// ==========================================================================
// P$ NOIR / PRIME ATELIER - INTERACTIVE FUNCTIONALITY
// ==========================================================================
...
const CART_STORAGE_KEY = 'psnoir_cart_v1';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function renderCart() {
    ...
    if (cart.length === 0) {
      cartItemsEl.innerHTML = '<p class="cart-empty-msg">Your Atelier bag is empty.</p>';
    } else {
  ...
  // ------------------------------------------------------------------
  // 5. Newsletter signup (placeholder — connect to your email provider)
  // ------------------------------------------------------------------
  if (newsletterForm) {
    newsletterForm.addEventListener('submit', (e) => {
      ...
      // TODO: replace this with a real request to Mailchimp / Klaviyo /
      // your own backend, e.g.:
      //   fetch('/api/newsletter-signup', { method: 'POST', body: JSON.stringify({ email }) })
      console.log('[Placeholder] Newsletter signup for:', email);
      statusEl.textContent = 'Thanks — you\u2019re on the list. (Placeholder: not yet connected to an email service.)';
